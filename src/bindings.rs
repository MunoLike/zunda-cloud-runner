...
pub type VoicevoxAccelerationMode = ::std::os::raw::c_uint;
...
#[doc = " 処理結果を示す結果コード"]
pub type VoicevoxResultCode = ::std::os::raw::c_uint;
...
pub struct voicevox_core {
    __library: ::libloading::Library,
    pub voicevox_make_default_initialize_options:
        unsafe extern "C" fn() -> VoicevoxInitializeOptions,
    pub voicevox_initialize:
        unsafe extern "C" fn(options: VoicevoxInitializeOptions) -> VoicevoxResultCode,
    pub voicevox_get_version: unsafe extern "C" fn() -> *const ::std::os::raw::c_char,
    pub voicevox_load_model: unsafe extern "C" fn(speaker_id: u32) -> VoicevoxResultCode,
    pub voicevox_is_gpu_mode: unsafe extern "C" fn() -> bool,
    pub voicevox_is_model_loaded: unsafe extern "C" fn(speaker_id: u32) -> bool,
    pub voicevox_finalize: unsafe extern "C" fn(),
    pub voicevox_get_metas_json: unsafe extern "C" fn() -> *const ::std::os::raw::c_char,
    pub voicevox_get_supported_devices_json:
        unsafe extern "C" fn() -> *const ::std::os::raw::c_char,
    pub voicevox_predict_duration: unsafe extern "C" fn(
        length: usize,
    ...
    pub voicevox_predict_duration_data_free: unsafe extern "C" fn(predict_duration_data: *mut f32),
    pub voicevox_predict_intonation: unsafe extern "C" fn(
        length: usize,
    ...
    pub voicevox_predict_intonation_data_free:
        unsafe extern "C" fn(predict_intonation_data: *mut f32),
    pub voicevox_decode: unsafe extern "C" fn(
        length: usize,
        phoneme_size: usize,
        f0: *mut f32,
    ...
    pub voicevox_decode_data_free: unsafe extern "C" fn(decode_data: *mut f32),
    pub voicevox_make_default_audio_query_options:
        unsafe extern "C" fn() -> VoicevoxAudioQueryOptions,
    pub voicevox_audio_query: unsafe extern "C" fn(
        text: *const ::std::os::raw::c_char,
        speaker_id: u32,
        options: VoicevoxAudioQueryOptions,
        output_audio_query_json: *mut *mut ::std::os::raw::c_char,
    ) -> VoicevoxResultCode,
    pub voicevox_make_default_synthesis_options: unsafe extern "C" fn() -> VoicevoxSynthesisOptions,
    pub voicevox_synthesis: unsafe extern "C" fn(
    ...
    pub voicevox_make_default_tts_options: unsafe extern "C" fn() -> VoicevoxTtsOptions,
    pub voicevox_tts: unsafe extern "C" fn(
        text: *const ::std::os::raw::c_char,
        speaker_id: u32,
    ...
    pub voicevox_audio_query_json_free:
        unsafe extern "C" fn(audio_query_json: *mut ::std::os::raw::c_char),
    pub voicevox_wav_free: unsafe extern "C" fn(wav: *mut u8),
    pub voicevox_error_result_to_message:
...
impl voicevox_core {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let voicevox_is_model_loaded = __library
            .get(b"voicevox_is_model_loaded\0")
            .map(|sym| *sym)?;
        let voicevox_finalize = __library.get(b"voicevox_finalize\0").map(|sym| *sym)?;
        let voicevox_get_metas_json = __library
            .get(b"voicevox_get_metas_json\0")
            .map(|sym| *sym)?;
    ...
    pub unsafe fn voicevox_predict_duration(
        ...
        (self.voicevox_predict_duration)(
            length,
            phoneme_vector,
            speaker_id,
    ...
    pub unsafe fn voicevox_predict_duration_data_free(
        &self,
        predict_duration_data: *mut f32,
    ) -> () {
        (self.voicevox_predict_duration_data_free)(predict_duration_data)
    }
    pub unsafe fn voicevox_predict_intonation(
        ...
        (self.voicevox_predict_intonation)(
            length,
    ...
    pub unsafe fn voicevox_predict_intonation_data_free(
        &self,
        predict_intonation_data: *mut f32,
    ) -> () {
        (self.voicevox_predict_intonation_data_free)(predict_intonation_data)
    }
    ...
    pub unsafe fn voicevox_decode_data_free(&self, decode_data: *mut f32) -> () {
        (self.voicevox_decode_data_free)(decode_data)
    }
    pub unsafe fn voicevox_make_default_audio_query_options(&self) -> VoicevoxAudioQueryOptions {
        (self.voicevox_make_default_audio_query_options)()
    }
    pub unsafe fn voicevox_audio_query(
        ...
        (self.voicevox_audio_query)(text, speaker_id, options, output_audio_query_json)
    }
    pub unsafe fn voicevox_make_default_synthesis_options(&self) -> VoicevoxSynthesisOptions {
        (self.voicevox_make_default_synthesis_options)()
    }
    ...
    pub unsafe fn voicevox_make_default_tts_options(&self) -> VoicevoxTtsOptions {
        (self.voicevox_make_default_tts_options)()
    }
